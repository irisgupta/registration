                ...
                <>
                    <div className={styles.container}>
                        ...
                        <div className={styles.imageBox}>
                            <Image className={styles.imageBorder} src={'/contour1.png'} height={450} width={450}></Image>
                        </div>
                        <div className={styles.imageBox}>
                            <Image className={styles.imageBorder} src={'/contour2.png'} height={450} width={450}></Image>
                        </div>
                ...
                : (partOrder[partInd] == 1) ?
                    <>
                        <div className={styles.container}>
                            ...
                            <div className={styles.imageBox}>
                                <Image className={styles.imageBorder} src={'/arrow1.png'} height={450} width={450}></Image>
                            </div>
                            <div className={styles.imageBox}>
                                <Image className={styles.imageBorder} src={'/arrow2.png'} height={450} width={450}></Image>
                            </div>
                            <Button variant="btn btn-success" onClick={continueChange}>
                                Continue
        </Button>
